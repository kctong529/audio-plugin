...
void Oscillator::renderNextBlock (AudioBuffer<double>& outputBuffer,
                                        int startSample, int numSamples)
{
    ...
    outputBuffer.makeCopyOf (subBuffer, true);
    renderNextBlock (outputBuffer, 0, numSamples);
    subBuffer.makeCopyOf (outputBuffer, true);
}
